...
\begin{table}[H]
  \centering
    ...
    \textbf{Age}                &&&&&&\\
    Mean age SD        &  $\Sexpr{ages.mean[1]} \pm \Sexpr{ages.sd[1]}$       
                       &  $\Sexpr{ages.mean[2]} \pm \Sexpr{ages.sd[2]}$   
                       &  $\Sexpr{ages.mean[3]} \pm \Sexpr{ages.sd[3]}$
                       &  $\Sexpr{ages.mean[4]} \pm \Sexpr{ages.sd[4]}$
                       &  $\Sexpr{ages.mean[5]} \pm \Sexpr{ages.sd[5]}$
                       &  $\Sexpr{ages.mean[6]} \pm \Sexpr{ages.sd[6]}$ \\
                                
    Median age IQR     &  $\Sexpr{ages.iqr[1]}$  &  $\Sexpr{ages.iqr[2]}$
                       &  $\Sexpr{ages.iqr[3]}$  &  $\Sexpr{ages.iqr[4]}$
                       &  $\Sexpr{ages.iqr[5]}$  &  $\Sexpr{ages.iqr[6]}$ \\
                               
    \textbf{Gender}             &&&&&&\\
    Women              &  $\Sexpr{female.count[1]}$  &  $\Sexpr{female.count[2]}$ 
                       &  $\Sexpr{female.count[3]}$  &  $\Sexpr{female.count[4]}$ 
                       &  $\Sexpr{female.count[5]}$  &  $\Sexpr{female.count[6]}$ \\
                       
    Men                &  $\Sexpr{male.count[1]}$  &  $\Sexpr{male.count[2]}$ 
                       &  $\Sexpr{male.count[3]}$  &  $\Sexpr{male.count[4]}$ 
                       &  $\Sexpr{male.count[5]}$  &  $\Sexpr{male.count[6]}$ \\
                       
    Number of patients &  $\Sexpr{male.count[1]+female.count[1]}$  &  $\Sexpr{male.count[2]+female.count[2]}$ 
                       &  $\Sexpr{male.count[3]+female.count[3]}$  &  $\Sexpr{male.count[4]+female.count[4]}$ 
                       &  $\Sexpr{male.count[5]+female.count[5]}$  &  $\Sexpr{male.count[6]+female.count[6]}$ \\
    \textbf{HCV genotype}       &&&&&&\\
    1                  &  $\Sexpr{type.df$type.1[1]}$  & $\Sexpr{type.df$type.1[2]}$ 
                       &  $\Sexpr{type.df$type.1[3]}$  & $\Sexpr{type.df$type.1[4]}$
                       &  $\Sexpr{type.df$type.1[5]}$  & $\Sexpr{type.df$type.1[6]}$\\
                       
    2                  &  $\Sexpr{type.df$type.2[1]}$  & $\Sexpr{type.df$type.2[2]}$ 
                       &  $\Sexpr{type.df$type.2[3]}$  & $\Sexpr{type.df$type.2[4]}$
                       &  $\Sexpr{type.df$type.2[5]}$  & $\Sexpr{type.df$type.2[6]}$\\
                       
    3                  &  $\Sexpr{type.df$type.3[1]}$  & $\Sexpr{type.df$type.3[2]}$ 
                       &  $\Sexpr{type.df$type.3[3]}$  & $\Sexpr{type.df$type.3[4]}$
                       &  $\Sexpr{type.df$type.3[5]}$  & $\Sexpr{type.df$type.3[6]}$\\
                       
    4                  &  $\Sexpr{type.df$type.4[1]}$  & $\Sexpr{type.df$type.4[2]}$ 
                       &  $\Sexpr{type.df$type.4[3]}$  & $\Sexpr{type.df$type.4[4]}$
                       &  $\Sexpr{type.df$type.4[5]}$  & $\Sexpr{type.df$type.4[6]}$\\
                       
    Other              &  $\Sexpr{type.df$type.Other[1]}$  & $\Sexpr{type.df$type.Other[2]}$ 
                       &  $\Sexpr{type.df$type.Other[3]}$  & $\Sexpr{type.df$type.Other[4]}$
                       &  $\Sexpr{type.df$type.Other[5]}$  & $\Sexpr{type.df$type.Other[6]}$\\
                       
    NA                 &  $\Sexpr{type.df$type.NA[1]}$  & $\Sexpr{type.df$type.NA[2]}$ 
                       &  $\Sexpr{type.df$type.NA[3]}$  & $\Sexpr{type.df$type.NA[4]}$
                       &  $\Sexpr{type.df$type.NA[5]}$  & $\Sexpr{type.df$type.NA[6]}$\\\hline
    \end{tabular}
